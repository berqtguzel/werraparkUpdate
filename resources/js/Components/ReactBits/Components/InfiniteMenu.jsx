...
import "../../../../css/ReactBits/Components/InfiniteMenu.css";
...
class Geometry {
    ...
    getMidPoint(ndxA, ndxB, cache) {
        const cacheKey =
            ndxA < ndxB ? `k_${ndxB}_${ndxA}` : `k_${ndxA}_${ndxB}`;
...
class InfiniteGridMenu {
    ...
    #init(onInit) {
        ...
        this.discLocations = {
            ...
            uWorldMatrix: gl.getUniformLocation(
                this.discProgram,
                "uWorldMatrix"
            ),
            ...
            uScaleFactor: gl.getUniformLocation(
                this.discProgram,
                "uScaleFactor"
            ),
